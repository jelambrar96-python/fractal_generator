...
def draw_fractal(center, side_length, degrees_rotate, thickness, colour, \
                  pixels, shrink_side_by, max_depth, iteration=0):
    ...
    for line in lines:
        ...
        if (iteration < max_depth and (iteration < 1 or line_number < 3)):
            ...
            draw_fractal(new_center, new_side_length, new_rotation, \
                          thickness, colour, pixels, shrink_side_by, \
                          max_depth, iteration+1)
